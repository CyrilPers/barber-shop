...
export const convertDate = (date) => {
    ...
    // Check if date and month have 1 figure number, if have 1 figure we add 0.
    ...
    // let day = dateObj.getDay().toString().length === 1 ? dateObj.getDay().toString().padStart(2, '0') : dateObj.getDay().toString();
}